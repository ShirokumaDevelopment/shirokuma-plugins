...
## Schema Documentation (shirokuma-flow)

Describe columns and indexes with inline JSDoc comments. shirokuma-flow automatically extracts them for documentation.
