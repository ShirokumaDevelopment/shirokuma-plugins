...
### Automated (future shirokuma-flow command)

```bash
# Proposed command
shirokuma-flow lint annotations -p . -c .shirokuma/config.yaml
...
### Proposed shirokuma-flow lint annotations
...
shirokuma-flow lint annotations -f terminal

# JSON (machine-readable)
shirokuma-flow lint annotations -f json -o /tmp/shirokuma-flow/annotations.json

# Fix mode (auto-update annotations)
shirokuma-flow lint annotations --fix
```
...
- [shirokuma-annotations.md](../../../../rules/shirokuma-flow/shirokuma-annotations.md) - Annotation reference
- [shirokuma-flow-verification.md](./shirokuma-flow-verification.md) - General verification workflow
