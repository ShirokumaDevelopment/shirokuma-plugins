...
| 2 | 関連 Discussion 検索 | 既存 Discussion を検索中 | Bash: `shirokuma-flow discussion adr list` + `discussion search` |
...
### ステップ 2: 関連参照の自動探索（重複・矛盾チェック + 本文埋め込み）
...
| `doc-search-rules` ルール（共有） | ステップ 2 の正本ドキュメント・ADR・既存 Issue 探索ロジック・配置仕様 |
