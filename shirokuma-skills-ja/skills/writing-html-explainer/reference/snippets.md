...
<div class="bubble">
  ...
  <div class="bubble-body">
    ...
    <p><code>setItemFields</code> 内のバリデーションは ADR-v3-022 で廃止された。各 CLI 入口で行うこと。</p>
    <ul class="checklist">
...
<div class="board">
  <section class="board-lane">
    ...
    <article class="board-item">
      <p class="board-item-title">#2620 HTML レポート展開</p>
      <p class="board-item-meta">epic · 8 subs</p>
    </article>
    <article class="board-item">
      <p class="board-item-title">#2622 ギャラリー強化</p>
  ...
  <section class="board-lane">
    ...
    <article class="board-item">
      <p class="board-item-title">#2635 残り 5 系統追加</p>
