...
Designed for automated checks by shirokuma-flow and efficient reviews.
...
## shirokuma-flow Integration

This rule is used by the following shirokuma-flow features:
