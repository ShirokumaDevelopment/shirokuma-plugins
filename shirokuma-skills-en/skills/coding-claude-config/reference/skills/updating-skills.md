...
> upstream is updated via `shirokuma-flow init --with-skills` or plugin update.
...
- [best-practices.md](best-practices.md) - Creation best practices
- [examples.md](examples.md) - Example skills
