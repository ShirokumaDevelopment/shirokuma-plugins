...
### 6. Artifact Review Results (only when artifact review targets exist)

**Review results for GitHub documents (Discussion / Issue) created or updated as PR artifacts**

> Display this section only when "Artifact review targets:" is present. Omit if no artifacts exist.

| Artifact | Type | Assessment | Finding |
|----------|------|------------|---------|
| #N Title | Discussion/Issue | OK/Needs Fix | Finding details (or "—" if none) |
